...
public interface IProductKitService
{
    ...
    Task<ProductKitOptionsDto?> GetKitOptionsAsync(int productId, string? sessionId, int? currentUserId, bool forAdminPanel = false);
    Task EnrichProductDtoAsync(ProductDto dto, string? sessionId, int? currentUserId, bool forAdminPanel = false);
